  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Basic technology infrastructure review",
        "Custom application development (1 app)",
        "Cloud migration strategy",
        "3 months of support and training",
        "Monthly progress reports",
      ],
      buttonText: "Get Started",
      buttonClass:
        "bg-gradient-to-r from-primary to-secondary text-white shadow-[0px_1px_1px_-0.5px_rgba(16,24,40,0.20)] hover:from-primary-dark hover:to-secondary-dark transition-all duration-300",
    },
    {
      name: "Professional",
      monthlyPrice: "$5,000",
      annualPrice: "$50,000",
      description: "Ideal for growing businesses ready for comprehensive transformation.",
      features: [
        "Complete digital transformation roadmap",
        "Multiple custom applications (up to 3)",
        "Enterprise system integration",
        "Advanced cloud migration & optimization",
        "AI & automation implementation",
        "6 months of dedicated support",
        "Priority consulting and strategy sessions",
    ...
    },
    {
      ...
      features: [
        "Full-scale digital transformation program",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a transformation package that aligns with your business goals, from small businesses <br /> starting their digital journey to large enterprises seeking comprehensive transformation.
          </p>
        </div>
        <div className="pt-4">
