    ...
    >
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        ...
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          ARTORITHM empowers businesses with cutting-edge digital solutions, custom applications, and transformative technology strategies that drive growth and efficiency.
        </p>
      </div>

      <Link href="#contact">
        <Button className="relative z-10 bg-gradient-to-r from-primary to-secondary text-white hover:from-primary-dark hover:to-secondary-dark px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 transition-all duration-300">
