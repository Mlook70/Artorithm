      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Join hundreds of businesses that have successfully transformed their operations with ARTORITHM's comprehensive digital solutions and expert guidance.
          </p>
        </div>
        <Link href="#contact">
          <Button
            className="px-[30px] py-2 bg-gradient-to-r from-primary to-secondary text-white text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:from-primary-dark hover:to-secondary-dark transition-all duration-300"
            size="lg"
          >
